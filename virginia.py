...
# Note: merged the city output back into the county output temporarily because that's
# how TurboVote injests it. We have a card to address the true nature of this data
# both here and in TV at a later time.
